                    ...
                    <c:forEach var="request" items="${listReq}">
                        <tr>
                            ...
                            <c:if test="${request.status eq 'Open' || request.status eq 'Rejected'}">
                                <td class="btn-container" style="width: 30px;text-align: center;">
                                    <a href="updatereq?idrequest=${request.idRequest} " class="btn btn-info">Update</a>
                                </td>
                            </c:if>         
                        ...
                        <form id="paymentForm" action="vnpay" method="post">
                            ...
                            <td style="width: 10%; text-align: center;">
                                <a class="btn btn-primary" type="submit">Payment</a>
                            </td>
                        </form>
                    </c:if>
                    <c:if test="${request.status eq 'Completed'}">
                        <td class="btn-container" style="width: 10%;text-align: center;">
                            <a href="rate?idrequest=${request.idRequest}&idMentor=${request.idMentor}&idMentee=${request.idMentee}" class="btn btn-secondary">Finish</a>
                        </td>
                    </c:if>
                    <td>
                        <c:if test="${request.status == 'Completed'}">
                            <a class="btn btn-danger" onclick="showRePortForm(${request.idRequest},${request.idMentor});" >
                                Report
                            </a>
                        </c:if>
                    </td>
